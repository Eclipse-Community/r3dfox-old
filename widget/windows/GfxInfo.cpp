...
#define IMPLEMENT_INTEL_DRIVER_BLOCKLIST_D2D(winVer, devFamily, driverVer,   \
  ...
  APPEND_TO_DRIVER_BLOCKLIST2(                                               \
    ...
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST_D2D(OperatingSystem::WindowsVista, IntelGMA500,
                                         1006, "FEATURE_FAILURE_594877_1");
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST_D2D(OperatingSystem::WindowsVista, IntelGMA900,
                                         GfxDriverInfo::allDriverVersions,
                                         "FEATURE_FAILURE_594877_2");
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST_D2D(OperatingSystem::WindowsVista, IntelGMA950,
                                         1504, "FEATURE_FAILURE_594877_3");
    ...
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST(OperatingSystem::WindowsXP, IntelGMA500,
                                     V(3, 0, 20, 3200),
                                     "FEATURE_FAILURE_INTEL_1");
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST(OperatingSystem::WindowsXP, IntelGMA900,
                                     V(6, 14, 10, 4764),
                                     "FEATURE_FAILURE_INTEL_2");
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST(OperatingSystem::WindowsXP, IntelGMA950,
                                     V(6, 14, 10, 4926),
                                     "FEATURE_FAILURE_INTEL_3");
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST(OperatingSystem::WindowsXP, IntelGMA3150,
                                     V(6, 14, 10, 5134),
                                     "FEATURE_FAILURE_INTEL_4");
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST(OperatingSystem::WindowsXP, IntelGMAX3000,
                                     V(6, 14, 10, 5218),
                                     "FEATURE_FAILURE_INTEL_5");
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST(OperatingSystem::WindowsXP, IntelGMAX4500HD,
                                     V(6, 14, 10, 4969),
                                     "FEATURE_FAILURE_INTEL_6");
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST(
        OperatingSystem::WindowsXP, IntelHDGraphicsToSandyBridge,
    ...
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST(OperatingSystem::WindowsVista, IntelGMA500,
                                     V(3, 0, 20, 3200),
                                     "FEATURE_FAILURE_INTEL_9");
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST(OperatingSystem::WindowsVista, IntelGMA900,
                                     GfxDriverInfo::allDriverVersions,
                                     "FEATURE_FAILURE_INTEL_10");
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST(OperatingSystem::WindowsVista, IntelGMA950,
                                     V(7, 14, 10, 1504),
                                     "FEATURE_FAILURE_INTEL_11");
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST(OperatingSystem::WindowsVista, IntelGMA3150,
                                     V(7, 14, 10, 1910),
                                     "FEATURE_FAILURE_INTEL_12");
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST(OperatingSystem::WindowsVista, IntelGMAX3000,
                                     V(7, 15, 10, 1666),
                                     "FEATURE_FAILURE_INTEL_13");
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST(OperatingSystem::WindowsVista, IntelGMAX4500HD,
                                     V(7, 15, 10, 1666),
                                     "FEATURE_FAILURE_INTEL_14");
    IMPLEMENT_INTEL_DRIVER_BLOCKLIST(
        OperatingSystem::WindowsVista, IntelHDGraphicsToSandyBridge,
...
nsresult GfxInfo::GetFeatureStatusImpl(
  ...
  *aStatus = nsIGfxInfo::FEATURE_STATUS_UNKNOWN;
  ...
  if (!aDriverInfo.Length()) {
    ...
    if (!adapterVendorID.Equals(GfxDriverInfo::GetDeviceVendor(VendorIntel),
        ...
        // Also allow common virtual GPU vendor IDs (VirtualBox, VMware, QEMU/virtio, Parallels).
