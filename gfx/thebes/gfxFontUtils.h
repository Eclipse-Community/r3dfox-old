...
class gfxFontUtils {
 ...
 protected:
  ...
  // convert opentype name-table platform/encoding/language values to a
  // charset name we can use to convert the name data to unicode, or ""
  // if data is UTF16BE
  static const char* GetCharsetForFontName(uint16_t aPlatform,
                                           uint16_t aScript,
                                           uint16_t aLanguage);
