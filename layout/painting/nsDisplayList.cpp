    ...
    switch (nsStyleTransformMatrix::TransformFunctionOf(array)) {
      ...
      case eCSSKeyword_translatex: {
        double x = nsStyleTransformMatrix::ProcessTranslatePart(
            array->Item(1), contextIfGecko, aPresContext, conditions, &aRefBox,
      ...
      case eCSSKeyword_translatez: {
        double z = nsStyleTransformMatrix::ProcessTranslatePart(
            array->Item(1), contextIfGecko, aPresContext, conditions, nullptr);
      ...
      case eCSSKeyword_translate3d: {
        double x = nsStyleTransformMatrix::ProcessTranslatePart(
            ...
            &TransformReferenceBox::Width);
        double y = nsStyleTransformMatrix::ProcessTranslatePart(
            array->Item(2), contextIfGecko, aPresContext, conditions, &aRefBox,
            &TransformReferenceBox::Height);
        double z = nsStyleTransformMatrix::ProcessTranslatePart(
            array->Item(3), contextIfGecko, aPresContext, conditions, nullptr);
      ...
      case eCSSKeyword_matrix: {
        ...
        matrix._41 = ProcessTranslatePart(array->Item(5), contextIfGecko,
                                          aPresContext, conditions, &aRefBox,
                                          &TransformReferenceBox::Width);
      ...
      case eCSSKeyword_matrix3d: {
        ...
        matrix._42 = ProcessTranslatePart(array->Item(14), contextIfGecko,
                                          ...
                                          &TransformReferenceBox::Height);
        matrix._43 =
            ProcessTranslatePart(array->Item(15), contextIfGecko, aPresContext,
                                 conditions, &aRefBox, nullptr);
      ...
      case eCSSKeyword_interpolatematrix: {
        ...
        nsStyleTransformMatrix::ProcessInterpolateMatrix(
            matrix, array, contextIfGecko, aPresContext, conditions, aRefBox,
            &dummy);
        aFunctions.AppendElement(TransformMatrix(matrix));
        break;
      }
...
static void AddTransformFunctions(const nsCSSValueSharedList* aList,
  ...
  AddTransformFunctions(aList->mHead, aFrame->StyleContext(),
                        aFrame->PresContext(), aRefBox,
...
static void AddAnimationsForProperty(nsIFrame* aFrame,
                                     nsDisplayListBuilder* aBuilder,
                                     nsDisplayItem* aItem,
                                     nsCSSPropertyID aProperty,
                                     AnimationInfo& aAnimationInfo,
                                     bool aPending, bool aIsForWebRender) {
  if (aPending) {
...
nsDisplayListBuilder::nsDisplayListBuilder(nsIFrame* aReferenceFrame,
  ...
  mBuildCompositorHitTestInfo =
      mAsyncPanZoomEnabled && IsForPainting() &&
 ...
 */
static void RemoveModifiedFramesAndRects(
    nsDisplayListBuilder::WeakFrameRegion& aRegion) {
...
void nsDisplayListBuilder::ClearWillChangeBudget(nsIFrame* aFrame) {
...
static nsRect GetFrameArea(const nsDisplayListBuilder* aBuilder,
                           const nsIFrame* aFrame) {
  nsRect area;
...
bool nsDisplayListBuilder::ShouldBuildCompositorHitTestInfo(
    const nsIFrame* aFrame, const CompositorHitTestInfo& aInfo,
...
bool nsDisplayListBuilder::IsBuildingLayerEventRegions() {
...
/* static */ bool nsDisplayListBuilder::LayerEventRegionsEnabled() {
...
nsRect nsDisplayList::GetVisibleRect() const {
  nsRect result;
  for (nsDisplayItem* i = GetBottom(); i != nullptr; i = i->GetAbove()) {
...
already_AddRefed<LayerManager> nsDisplayList::PaintRoot(
  ...
  if (layerManager->GetBackendType() == layers::LayersBackend::LAYERS_WR) {
    ...
    WebRenderLayerManager* wrManager =
        static_cast<WebRenderLayerManager*>(layerManager.get());
  ...
  for (int32_t i = aState->mItemBuffer.Length() - 1; i >= itemBufferStart;
    ...
    bool same3DContext =
        ...
        (itemType == DisplayItemType::TYPE_PERSPECTIVE &&
         static_cast<nsDisplayPerspective*>(item)
             ->TransformFrame()
             ->Extend3DContext());
    if (same3DContext &&
        (itemType != DisplayItemType::TYPE_TRANSFORM ||
...
#endif
{
  ...
  SetClipChain(aBuilder->ClipState().GetCurrentCombinedClipChain(aBuilder),
               true);
...
bool nsDisplayItem::CanUseAdvancedLayer(LayerManager* aManager) const {
  if (!gfxPrefs::LayersAdvancedBasicLayerEnabled() && aManager &&
...
already_AddRefed<Layer> nsDisplayItem::BuildDisplayItemLayer(
    nsDisplayListBuilder* aBuilder, LayerManager* aManager,
    const ContainerLayerParameters& aContainerParameters) {
  RefPtr<Layer> oldLayer =
      aManager->GetLayerBuilder()->GetLeafLayerFor(aBuilder, this);
  RefPtr<DisplayItemLayer> layer =
      oldLayer ? oldLayer->AsDisplayItemLayer() : nullptr;
...
LayerState nsDisplaySolidColor::GetLayerState(
  ...
  if (ForceActiveLayers() ||
      ShouldUseAdvancedLayer(aManager, gfxPrefs::LayersAllowSolidColorLayers)) {
    return LAYER_ACTIVE;
  }
  return LAYER_NONE;
}
...
bool nsDisplaySolidColor::CreateWebRenderCommands(
  ...
  aBuilder.PushRect(transformedRect, transformedRect, !BackfaceIsHidden(),
...
nsDisplayBackgroundImage::GetInitData(
    nsDisplayListBuilder* aBuilder, nsIFrame* aFrame, uint32_t aLayer,
    const nsRect& aBackgroundRect, const nsStyleBackground* aBackgroundStyle) {
  nsPresContext* presContext = aFrame->PresContext();
  uint32_t flags = aBuilder->GetBackgroundPaintFlags();
  const nsStyleImageLayers::Layer& layer =
      aBackgroundStyle->mImage.mLayers[aLayer];
  ...
  bool shouldTreatAsFixed =
      layer.mAttachment == NS_STYLE_IMAGELAYER_ATTACHMENT_FIXED &&
      !isTransformedFixed;
...
/*static*/ bool nsDisplayBackgroundImage::AppendBackgroundItemsToTop(
    ...
    bool aAllowWillPaintBorderOptimization, nsStyleContext* aStyleContext,
...
bool nsDisplayBackgroundImage::CanBuildWebRenderDisplayItems(
    LayerManager* aManager) {
  return mBackgroundStyle->mImage.mLayers[mLayer].mClip !=
...
bool nsDisplayBackgroundImage::CreateWebRenderCommands(
  ...
  nsCSSRendering::PaintBGParams params =
      nsCSSRendering::PaintBGParams::ForSingleLayer(
          *StyleFrame()->PresContext(), mVisibleRect, mBackgroundRect,
...
nsRect nsDisplayBackgroundImage::GetPositioningArea() const {
  ...
  return nsCSSRendering::ComputeImageLayerPositioningArea(
             ...
             mBackgroundStyle->mImage.mLayers[mLayer], &attachedToFrame,
             &transformedFixed) +
         ToReferenceFrame();
}
...
void nsDisplayBackgroundImage::ComputeInvalidationRegion(
  ...
  const nsDisplayBackgroundGeometry* geometry =
...
void nsDisplayThemedBackground::ComputeInvalidationRegion(
    nsDisplayListBuilder* aBuilder, const nsDisplayItemGeometry* aGeometry,
    nsRegion* aInvalidRegion) const {
  const nsDisplayThemedBackgroundGeometry* geometry =
...
LayerState nsDisplayBackgroundColor::GetLayerState(
  ...
  if ((ForceActiveLayers() ||
       ShouldUseAdvancedLayer(aManager,
                              gfxPrefs::LayersAllowBackgroundColorLayers)) &&
...
void nsDisplayOutline::Paint(nsDisplayListBuilder* aBuilder, gfxContext* aCtx) {
  ...
  nsCSSRendering::PaintOutline(mFrame->PresContext(), *aCtx, mFrame,
                               mVisibleRect, nsRect(offset, mFrame->GetSize()),
                               mFrame->StyleContext());
}

LayerState nsDisplayOutline::GetLayerState(
    nsDisplayListBuilder* aBuilder, LayerManager* aManager,
    const ContainerLayerParameters& aParameters) {
  ...
  Maybe<nsCSSBorderRenderer> br =
      nsCSSRendering::CreateBorderRendererForOutline(
          mFrame->PresContext(), nullptr, mFrame, mVisibleRect,
          nsRect(offset, mFrame->GetSize()), mFrame->StyleContext());
...
already_AddRefed<Layer> nsDisplayOutline::BuildLayer(
    nsDisplayListBuilder* aBuilder, LayerManager* aManager,
    const ContainerLayerParameters& aContainerParameters) {
...
nsDisplayCompositorHitTestInfo::nsDisplayCompositorHitTestInfo(
    nsDisplayListBuilder* aBuilder, nsIFrame* aFrame,
    mozilla::gfx::CompositorHitTestInfo aHitTestInfo, uint32_t aIndex,
...
void nsDisplayCompositorHitTestInfo::WriteDebugInfo(
...
void nsDisplayLayerEventRegions::AddFrame(nsDisplayListBuilder* aBuilder,
                                          nsIFrame* aFrame) {
  NS_ASSERTION(aBuilder->FindReferenceFrameFor(aFrame) ==
                   aBuilder->FindReferenceFrameFor(mFrame),
               "Reference frame mismatch");
  CompositorHitTestInfo hitInfo = aFrame->GetCompositorHitTestInfo(aBuilder);
  ...
  if (aFrame != mFrame && aBuilder->IsRetainingDisplayList()) {
...
static void RemoveFrameFromFrameRects(
    nsDisplayLayerEventRegions::FrameRects& aFrameRects, nsIFrame* aFrame) {
  uint32_t i = 0;
...
void nsDisplayLayerEventRegions::RemoveFrame(nsIFrame* aFrame) {
...
void nsDisplayLayerEventRegions::AddInactiveScrollPort(nsIFrame* aFrame,
                                                       const nsRect& aRect) {
  mHitRegion.Add(aFrame, aRect);
  mDispatchToContentHitRegion.Add(aFrame, aRect);
}

bool nsDisplayLayerEventRegions::IsEmpty() const {
...
nsRegion nsDisplayLayerEventRegions::CombinedTouchActionRegion() {
  nsRegion result;
...
int32_t nsDisplayLayerEventRegions::ZIndex() const {
  return mOverrideZIndex ? *mOverrideZIndex : nsDisplayItem::ZIndex();
}

void nsDisplayLayerEventRegions::SetOverrideZIndex(int32_t aZIndex) {
  mOverrideZIndex = Some(aZIndex);
}

void nsDisplayLayerEventRegions::WriteDebugInfo(std::stringstream& aStream) {
  ...
  if (!mDispatchToContentHitRegion.IsEmpty()) {
    AppendToString(aStream, DispatchToContentHitRegion(),
...
LayerState nsDisplayCaret::GetLayerState(
    nsDisplayListBuilder* aBuilder, LayerManager* aManager,
    const ContainerLayerParameters& aParameters) {
...
already_AddRefed<Layer> nsDisplayCaret::BuildLayer(
    nsDisplayListBuilder* aBuilder, LayerManager* aManager,
    const ContainerLayerParameters& aContainerParameters) {
  return BuildDisplayItemLayer(aBuilder, aManager, aContainerParameters);
}
...
nsDisplayBorder::nsDisplayBorder(nsDisplayListBuilder* aBuilder,
                                 nsIFrame* aFrame)
    : nsDisplayItem(aBuilder, aFrame), mBorderIsEmpty(false) {
...
void nsDisplayBorder::ComputeInvalidationRegion(
    nsDisplayListBuilder* aBuilder, const nsDisplayItemGeometry* aGeometry,
    nsRegion* aInvalidRegion) const {
  const nsDisplayBorderGeometry* geometry =
      static_cast<const nsDisplayBorderGeometry*>(aGeometry);
  bool snap;
...
LayerState nsDisplayBorder::GetLayerState(
  ...
  Maybe<nsCSSBorderRenderer> br = nsCSSRendering::CreateBorderRenderer(
      ...
      nsRect(offset, mFrame->GetSize()), mFrame->StyleContext(),
      &mBorderIsEmpty, mFrame->GetSkipSides());
  ...
  NS_FOR_CSS_FULL_CORNERS(corner) {
    mCorners[corner] = LayerSize(br->mBorderRadii[corner].width,
...
already_AddRefed<Layer> nsDisplayBorder::BuildLayer(
    nsDisplayListBuilder* aBuilder, LayerManager* aManager,
    const ContainerLayerParameters& aContainerParameters) {
  if (mBorderIsEmpty) {
    return nullptr;
...
void nsDisplayBorder::CreateBorderImageWebRenderCommands(
    mozilla::wr::DisplayListBuilder& aBuilder,
    mozilla::wr::IpcResourceUpdateQueue& aResources,
    const StackingContextHelper& aSc,
    mozilla::layers::WebRenderLayerManager* aManager,
  ...
  NS_FOR_CSS_SIDES(i) {
    slice[i] =
        (float)(mBorderImageRenderer->mSlice.Side(i)) / appUnitsPerDevPixel;
    widths[i] =
        (float)(mBorderImageRenderer->mWidths.Side(i)) / appUnitsPerDevPixel;
    outset[i] = (float)(mBorderImageRenderer->mImageOutset.Side(i)) /
                appUnitsPerDevPixel;
  }
  ...
  switch (mBorderImageRenderer->mImageRenderer.GetType()) {
    case eStyleImageType_Image: {
      ...
      RefPtr<imgIContainer> img =
          mBorderImageRenderer->mImageRenderer.GetImage();
      Maybe<SVGImageContext> svgContext;
      gfx::IntSize decodeSize =
          nsLayoutUtils::ComputeImageContainerDrawingParameters(
              img, mFrame, destRect, aSc, flags, svgContext);
      ...
      Maybe<wr::ImageKey> key = aManager->CommandBuilder().CreateImageKey(
          this, container, aBuilder, aResources, aSc, size, Nothing());
      if (key.isNothing()) {
        return;
      }

      aBuilder.PushBorderImage(
          dest, clip, !BackfaceIsHidden(),
          wr::ToBorderWidths(widths[0], widths[1], widths[2], widths[3]),
          key.value(),
          wr::ToNinePatchDescriptor(
              (float)(mBorderImageRenderer->mImageSize.width) /
                  appUnitsPerDevPixel,
              (float)(mBorderImageRenderer->mImageSize.height) /
                  appUnitsPerDevPixel,
    ...
    case eStyleImageType_Gradient: {
      RefPtr<nsStyleGradient> gradientData =
          mBorderImageRenderer->mImageRenderer.GetGradientData();
...
void nsDisplayBorder::Paint(nsDisplayListBuilder* aBuilder, gfxContext* aCtx) {
  ...
  ImgDrawResult result = nsCSSRendering::PaintBorder(
      ...
      nsRect(offset, mFrame->GetSize()), mFrame->StyleContext(), flags,
      mFrame->GetSkipSides());
...
already_AddRefed<Layer> nsDisplayBoxShadowOuter::BuildLayer(
    nsDisplayListBuilder* aBuilder, LayerManager* aManager,
    const ContainerLayerParameters& aContainerParameters) {
  return BuildDisplayItemLayer(aBuilder, aManager, aContainerParameters);
}
...
already_AddRefed<Layer> nsDisplayBoxShadowInner::BuildLayer(
    nsDisplayListBuilder* aBuilder, LayerManager* aManager,
    const ContainerLayerParameters& aContainerParameters) {
  return BuildDisplayItemLayer(aBuilder, aManager, aContainerParameters);
}
...
bool nsDisplayWrapList::CreateWebRenderCommands(
  ...
  aManager->CommandBuilder().CreateWebRenderCommandsFromDisplayList(
      GetChildren(), aDisplayListBuilder, aSc, aBuilder, aResources);
  return true;
}
...
#ifdef NS_BUILD_REFCNT_LOGGING
nsDisplayOpacity::~nsDisplayOpacity() { MOZ_COUNT_DTOR(nsDisplayOpacity); }
#endif
...
bool nsDisplayOpacity::CreateWebRenderCommands(
  ...
  AddAnimationsForProperty(Frame(), aDisplayListBuilder, this,
                           eCSSProperty_opacity, animationInfo, false, true);
  ...
  aManager->CommandBuilder().CreateWebRenderCommandsFromDisplayList(
      &mList, aDisplayListBuilder, sc, aBuilder, aResources);
  return true;
}
...
nsDisplayOwnLayer::nsDisplayOwnLayer(
    ...
    const ScrollThumbData& aThumbData, bool aForceActive, bool aClearClipChain)
...
#ifdef NS_BUILD_REFCNT_LOGGING
nsDisplayOwnLayer::~nsDisplayOwnLayer() { MOZ_COUNT_DTOR(nsDisplayOwnLayer); }
#endif
...
bool nsDisplayOwnLayer::UpdateScrollData(
  ...
  if (mFlags & nsDisplayOwnLayerFlags::eScrollbarContainer) {
    ...
    if (aLayerData) {
      ScrollDirection dir =
          (mFlags & nsDisplayOwnLayerFlags::eVerticalScrollbar)
              ? ScrollDirection::eVertical
              : ScrollDirection::eHorizontal;
...
UniquePtr<ScrollMetadata> nsDisplaySubDocument::ComputeScrollMetadata(
  ...
  return MakeUnique<ScrollMetadata>(nsLayoutUtils::ComputeScrollMetadata(
...
already_AddRefed<Layer> nsDisplayFixedPosition::BuildLayer(
  ...
  if (viewportFrame) {
    ...
    if (presContext->PresShell()->IsScrollPositionClampingScrollPortSizeSet()) {
      anchorRect.SizeTo(
          presContext->PresShell()->GetScrollPositionClampingScrollPortSize());
    } else {
...
bool nsDisplayStickyPosition::CreateWebRenderCommands(
  ...
  if (stickyScrollContainer) {
    ...
    wr::WrStickyId id = aBuilder.DefineStickyFrame(
        aSc.ToRelativeLayoutRect(bounds), topMargin.ptrOr(nullptr),
...
#ifdef NS_BUILD_REFCNT_LOGGING
nsDisplayZoom::~nsDisplayZoom() { MOZ_COUNT_DTOR(nsDisplayZoom); }
#endif
...
/* static */ Point3D nsDisplayTransform::GetDeltaToTransformOrigin(
  ...
  NS_PRECONDITION(aFrame->IsTransformed() || aFrame->BackfaceIsHidden() ||
...
Matrix4x4 nsDisplayTransform::GetResultingTransformMatrixInternal(
  ...
  if (aProperties.mTransformList) {
    result = nsStyleTransformMatrix::ReadTransforms(
        ...
        frame ? frame->PresContext() : nullptr, dummy, refBox,
        aAppUnitsPerPixel, &dummyBool);
...
bool nsDisplayTransform::CreateWebRenderCommands(
  ...
  AnimationInfo& animationInfo = animationData->GetAnimationInfo();
  AddAnimationsForProperty(Frame(), aDisplayListBuilder, this,
                           eCSSProperty_transform, animationInfo, false, true);
  animationInfo.StartPendingAnimations(aManager->GetAnimationReadyTime());
  ...
  StackingContextHelper sc(
      aSc, aBuilder, filters, LayoutDeviceRect(position, LayoutDeviceSize()),
      &newTransformMatrix, animationsId ? &prop : nullptr, nullptr,
      transformForSC, nullptr, gfx::CompositionOp::OP_OVER, !BackfaceIsHidden(),
...
already_AddRefed<Layer> nsDisplayTransform::BuildLayer(
  ...
  const bool shouldSkipTransform = (aBuilder->RootReferenceFrame() == mFrame) &&
 ...
 * works.
 */
Maybe<nscolor> nsDisplayTransform::IsUniform(
    nsDisplayListBuilder* aBuilder) const {
  nsRect untransformedVisible;
  if (!UntransformVisibleRect(aBuilder, &untransformedVisible)) {
    return Nothing();
...
bool nsDisplayTransform::UntransformVisibleRect(nsDisplayListBuilder* aBuilder,
  ...
  const Matrix4x4Flagged& matrix = GetTransform();
  if (matrix.IsSingular()) return false;
...
already_AddRefed<Layer> nsDisplayPerspective::BuildLayer(
  ...
  DebugOnly<bool> hasPerspective = nsDisplayTransform::ComputePerspectiveMatrix(
      mTransformFrame, appUnitsPerPixel, perspectiveMatrix);
...
bool nsDisplayPerspective::CreateWebRenderCommands(
  ...
  nsTArray<mozilla::wr::WrFilterOp> filters;
  StackingContextHelper sc(aSc, aBuilder, filters, LayoutDeviceRect(), nullptr,
                           nullptr, nullptr, &transformForSC,
                           &perspectiveMatrix, gfx::CompositionOp::OP_OVER,
                           !BackfaceIsHidden(), true);
...
void nsCharClipDisplayItem::ComputeInvalidationRegion(
    nsDisplayListBuilder* aBuilder, const nsDisplayItemGeometry* aGeometry,
    nsRegion* aInvalidRegion) const {
  const nsCharClipGeometry* geometry =
      static_cast<const nsCharClipGeometry*>(aGeometry);
...
nsDisplaySVGEffects::nsDisplaySVGEffects(
    nsDisplayListBuilder* aBuilder, nsIFrame* aFrame, nsDisplayList* aList,
    bool aHandleOpacity, const ActiveScrolledRoot* aActiveScrolledRoot,
...
void nsDisplaySVGEffects::HitTest(nsDisplayListBuilder* aBuilder,
                                  const nsRect& aRect, HitTestState* aState,
                                  nsTArray<nsIFrame*>* aOutFrames) {
...
gfxPoint nsDisplaySVGEffects::UserSpaceOffset() const {
  return nsSVGUtils::FrameSpaceInCSSPxToUserSpaceOffset(mFrame);
}

void nsDisplaySVGEffects::ComputeInvalidationRegion(
    nsDisplayListBuilder* aBuilder, const nsDisplayItemGeometry* aGeometry,
    nsRegion* aInvalidRegion) const {
...
nsDisplayMask::nsDisplayMask(nsDisplayListBuilder* aBuilder, nsIFrame* aFrame,
...
#ifdef NS_BUILD_REFCNT_LOGGING
nsDisplayMask::~nsDisplayMask() { MOZ_COUNT_DTOR(nsDisplayMask); }
#endif
...
bool nsDisplayMask::CanMerge(const nsDisplayItem* aItem) const {
  // Items for the same content element should be merged into a single
  // compositing group.
  if (!HasSameTypeAndClip(aItem) || !HasSameContent(aItem)) {
    return false;
...
already_AddRefed<Layer> nsDisplayMask::BuildLayer(
    nsDisplayListBuilder* aBuilder, LayerManager* aManager,
    const ContainerLayerParameters& aContainerParameters) {
  if (!ValidateSVGFrame()) {
    return nullptr;
...
bool nsDisplayMask::PaintMask(nsDisplayListBuilder* aBuilder,
  ...
  nsSVGIntegrationUtils::PaintFramesParams params(
      *aMaskContext, mFrame, mVisibleRect, borderArea, aBuilder, nullptr,
...
LayerState nsDisplayMask::GetLayerState(
    nsDisplayListBuilder* aBuilder, LayerManager* aManager,
    const ContainerLayerParameters& aParameters) {
...
void nsDisplayMask::ComputeInvalidationRegion(
    nsDisplayListBuilder* aBuilder, const nsDisplayItemGeometry* aGeometry,
    nsRegion* aInvalidRegion) const {
...
void nsDisplayMask::PaintAsLayer(nsDisplayListBuilder* aBuilder,
  ...
  nsRect borderArea = nsRect(ToReferenceFrame(), mFrame->GetSize());
  nsSVGIntegrationUtils::PaintFramesParams params(
      *aCtx, mFrame, mVisibleRect, borderArea, aBuilder, aManager,
...
bool nsDisplayMask::CreateWebRenderCommands(
    mozilla::wr::DisplayListBuilder& aBuilder,
    mozilla::wr::IpcResourceUpdateQueue& aResources,
    const StackingContextHelper& aSc,
    mozilla::layers::WebRenderLayerManager* aManager,
  ...
  LayoutDeviceRect bounds =
      LayoutDeviceRect::FromAppUnits(displayBound, appUnitsPerDevPixel);
  ...
  if (mask) {
    wr::WrClipId clipId = aBuilder.DefineClip(Nothing(), Nothing(),
                                              aSc.ToRelativeLayoutRect(bounds),
                                              nullptr, mask.ptr());
  ...
  nsDisplaySVGEffects::CreateWebRenderCommands(aBuilder, aResources, aSc,
                                               aManager, aDisplayListBuilder);
...
Maybe<nsRect> nsDisplayMask::GetClipWithRespectToASR(
    nsDisplayListBuilder* aBuilder, const ActiveScrolledRoot* aASR) const {
  if (const DisplayItemClip* clip =
          DisplayItemClipChain::ClipForASR(GetClipChain(), aASR)) {
    return Some(clip->GetClipRect());
...
#ifdef MOZ_DUMP_PAINTING
void nsDisplayMask::PrintEffects(nsACString& aTo) {
  nsIFrame* firstFrame =
      nsLayoutUtils::FirstContinuationOrIBSplitSibling(mFrame);
  SVGObserverUtils::EffectProperties effectProperties =
      SVGObserverUtils::GetEffectProperties(firstFrame);
...
#ifdef NS_BUILD_REFCNT_LOGGING
nsDisplayFilter::~nsDisplayFilter() { MOZ_COUNT_DTOR(nsDisplayFilter); }
#endif

already_AddRefed<Layer> nsDisplayFilter::BuildLayer(
    nsDisplayListBuilder* aBuilder, LayerManager* aManager,
    const ContainerLayerParameters& aContainerParameters) {
  if (!ValidateSVGFrame()) {
    return nullptr;
...
LayerState nsDisplayFilter::GetLayerState(
    nsDisplayListBuilder* aBuilder, LayerManager* aManager,
    const ContainerLayerParameters& aParameters) {
  return LAYER_SVG_EFFECTS;
}
...
void nsDisplayFilter::ComputeInvalidationRegion(
    nsDisplayListBuilder* aBuilder, const nsDisplayItemGeometry* aGeometry,
    nsRegion* aInvalidRegion) const {
  nsDisplaySVGEffects::ComputeInvalidationRegion(aBuilder, aGeometry,
                                                 aInvalidRegion);
...
void nsDisplayFilter::PaintAsLayer(nsDisplayListBuilder* aBuilder,
                                   gfxContext* aCtx, LayerManager* aManager) {
  imgDrawingParams imgParams(aBuilder->ShouldSyncDecodeImages()
                                 ? imgIContainer::FLAG_SYNC_DECODE
                                 : imgIContainer::FLAG_SYNC_DECODE_IF_FAST);
...
bool nsDisplayFilter::CreateWebRenderCommands(
    mozilla::wr::DisplayListBuilder& aBuilder,
    mozilla::wr::IpcResourceUpdateQueue& aResources,
    const StackingContextHelper& aSc,
    mozilla::layers::WebRenderLayerManager* aManager,
  ...
  StackingContextHelper sc(
      aSc, aBuilder, wrFilters, LayoutDeviceRect(), nullptr, nullptr,
      opacity != 1.0f && mHandleOpacity ? &opacity : nullptr);

  nsDisplaySVGEffects::CreateWebRenderCommands(aBuilder, aResources, sc,
                                               aManager, aDisplayListBuilder);
  return true;
}

#ifdef MOZ_DUMP_PAINTING
void nsDisplayFilter::PrintEffects(nsACString& aTo) {
  nsIFrame* firstFrame =
      nsLayoutUtils::FirstContinuationOrIBSplitSibling(mFrame);
  SVGObserverUtils::EffectProperties effectProperties =
      SVGObserverUtils::GetEffectProperties(firstFrame);
...
PaintTelemetry::AutoRecordPaint::~AutoRecordPaint() {
  ...
  auto recordSmall = [=](const nsString& aKey, double aDurationMs) -> void {
    MOZ_ASSERT(aDurationMs <= totalMs);
    uint32_t amount = static_cast<int32_t>((aDurationMs / totalMs) * 100.0);
    Telemetry::ScalarAdd(Telemetry::ScalarID::GFX_SMALL_PAINT_PHASE_WEIGHT,
                         aKey, amount);
  };
