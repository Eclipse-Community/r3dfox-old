...
#define APP_REG_NAME_BASE L"eXPlorer-"
...
static bool IsPathDefaultForClass(
  ...
  LPCWSTR progID = isProtocol ? L"eXPlorerURL" : L"eXPlorerHTML";
...
static nsresult DynSHOpenWithDialog(HWND hwndParent, const OPENASINFO *poainfo) {
