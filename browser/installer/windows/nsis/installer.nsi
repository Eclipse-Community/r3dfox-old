...
Section "-Application" APP_IDX
  ...
  ${Else}
    ...
    ReadRegStr $0 HKLM "Software\${CompanyName}.org\${CompanyName}" "CurrentVersion"
    ${If} "$0" != "${GREVersion}"
      WriteRegStr HKLM "Software\${CompanyName}.org\${CompanyName}" "CurrentVersion" "${GREVersion}"
    ${EndIf}
  ${EndIf}
  ...
  ${If} $TmpVal == "HKLM"
    ; Set the permitted LSP Categories for Vista and above
...
Function .onInit
  ...
  ; Windows NT 5.0 (2000) and lower are not supported.
