...
struct ServoStyleSheetInner final : public StyleSheetInfo {
  ServoStyleSheetInner(CORSMode aCORSMode, ReferrerPolicy aReferrerPolicy,
...
class ServoStyleSheet : public StyleSheet {
 public:
  ServoStyleSheet(css::SheetParsingMode aParsingMode, CORSMode aCORSMode,
 ...
 private:
  ServoStyleSheet(const ServoStyleSheet& aCopy, ServoStyleSheet* aParentToUse,
